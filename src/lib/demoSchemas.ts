...
export const demoFormSchema = z.object({
  ...
  grade: z.enum(['7', '8', '9', '10', '11', '12', 'btech-1', 'btech-2', 'btech-3', 'btech-4', 'other'], {
    required_error: 'Please select your academic level',
  }),
  institution: z.string().min(2, 'Please enter your institution or academy name').max(150, 'Institution name is too long'),
