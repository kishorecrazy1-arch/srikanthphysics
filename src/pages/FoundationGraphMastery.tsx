...
export function FoundationGraphMastery() {
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-teal-900 to-slate-900 text-white p-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            <h1 className="text-4xl font-bold mb-2">Foundation Graph Mastery</h1>
            <p className="text-teal-200">AI-powered graph problems for Foundation Physics (kinematics &amp; motion)</p>
          </div>
          <button
