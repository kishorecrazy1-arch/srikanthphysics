  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (result.success) {
        ...
        const batchId = selectedBatch || (validation.data.board?.includes('Foundation') ? validation.data.board : null);
        const isFoundationBatch = batchId && (
          batchId === 'foundation-batch-1' ||
          batchId === 'foundation-batch-2' ||
          batchId === 'foundation-batch-3' ||
          validation.data.board === 'Foundation Course' ||
        ...
        <div>
          ...
          <select
            ...
            onChange={(e) => {
              ...
              handleChange('board', selectedValue);
              
              // If Foundation Course is selected, navigate to batch selection page
              if (selectedValue === 'Foundation Course') {
                navigate('/foundation');
              }
            }}
            className="w-full px-4 py-3 border-2 border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors"
          ...
          >
            ...
            {selectedBatch ? (
              ...
              // Otherwise show all courses with Foundation Course as single option
              <>
