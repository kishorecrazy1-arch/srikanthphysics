...
export const demoFormSchema = z.object({
  ...
  grade: z.enum(['7', '8', '9', '10', '11', '12', 'btech-1', 'btech-2', 'btech-3', 'btech-4', 'other']).optional().or(z.literal('')),
  institution: z.string().max(150, 'Institution name is too long').optional().or(z.literal('')),
